({
  doInit: function(component, event, helper) {
     ...
     //Shubham 18/07 Start
      ...
      var action1 = component.get('c.getTargetReportMetadata');
        action1.setParams({ 
            reportId: component.get("v.targetReportIdAttribute")
        });
       ...
       //handle response from Apex controller
        action1.setCallback(this, function(response){
            ...
            {
                component.set("v.targetVal",returnValue);
            }
            else
            {
                component.set("v.targetVal",'');
            }
        })
    ...
    if (factMap) {
      ...
      if(Sequence !== undefined && Sequence!= null)
      {
          ...
          component.set("v.listSequence", listSequence);
      }
